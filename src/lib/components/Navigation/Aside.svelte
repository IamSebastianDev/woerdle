<script>
	...
	import { showNav, toggleNav } from '../../stores/menu.store.js';
...
{#if $showNav}
	<aside
		...
		class="fixed left-0 top-0 bottom-0 flex h-screen w-full max-w-sm flex-col border-r border-zinc-200 px-4 pt-20 pb-4 shadow-xl dark:border-zinc-800 dark:bg-zinc-900"
	>
