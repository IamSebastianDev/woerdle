...
<aside
	...
	class="fixed left-0 top-0 bottom-0 z-20 flex h-screen w-full max-w-sm flex-col border-r border-zinc-200 px-4 pt-20 pb-4 shadow-xl dark:border-zinc-800 dark:bg-zinc-900"
>
